This project is a luck checker game built using HTML, CSS, and JavaScript. It allows users to guess a number and checks if they are lucky based on predefined criteria.
